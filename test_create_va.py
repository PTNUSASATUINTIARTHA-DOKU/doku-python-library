...
class TestCreateVa(unittest.TestCase):

    def setUp(self) -> None:
        self.create_va_url = "/virtual-accounts/bi-snap-va/v1.1/transfer-va/create-va"
    
    @patch('requests.post')
    def test_create_va_success_bca(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        ...
        response = requests.post(Config.get_base_url(is_production=False)+self.create_va_url, json=request.create_request_body())

        mock_data.assert_called_with(Config.get_base_url(is_production=False)+self.create_va_url, json=request.create_request_body())
        self.assertEqual(response.json().response_code, resp_dict.response_code)
    
    @patch('requests.post')
    def test_create_va_success_mandiri(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_bri(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_bni(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_danamon(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_permata(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_maybank(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_bnc(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_btn(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_bsi(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_cimb(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_sinarmas(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_doku(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    @patch('requests.post')
    def test_create_va_success_bss(self, mock_data):
        mock_resp = Mock()
        resp_dict = Util.generate_create_va_response(response_code="2002700")
        mock_resp.json.return_value = resp_dict
        mock_data.return_value = mock_resp
    ...
    def test_create_va_partner_service_id_null(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_partner_service_id_not_valid_length(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_partner_service_id_not_valid_format(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_customer_no_null(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_customer_no_not_valid_length(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_customer_no_not_valid_format(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_virtual_acc_no_null(self):
        request = Util.generate_create_va_request()
        request.virtual_account_no = None
        with self.assertRaises(Exception) as context:
            request.validate_va_request()
    ...
    def test_create_va_virtual_acc_no_not_valid_format(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_virtual_acc_name_null(self):
        request = Util.generate_create_va_request()
        request.virtual_acc_name = None
        with self.assertRaises(Exception) as context:
            request.validate_va_request()
        self.assertEqual(str(context.exception.args[0]), "virtualAccountName cannot be null. Please provide a virtualAccountName. Example: 'Toru Yamashita'.")
    
    def test_create_va_virtual_acc_name_not_valid_length_min(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_virtual_acc_name_not_valid_length_max(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_virtual_acc_name_not_valid_char(self):
        request = Util.generate_create_va_request()
        request.virtual_acc_name = "$%%^$"
        with self.assertRaises(Exception) as context:
            request.validate_va_request()
    ...
    def test_create_va_virtual_acc_email_not_valid_length_min(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_virtual_acc_email_not_valid_length_max(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_virtual_acc_email_not_valid_format(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_virtual_acc_phone_not_valid_length_min(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_virtual_acc_phone_not_valid_length_max(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_trx_id_null(self):
        request = Util.generate_create_va_request()
        request.trx_id = None
        with self.assertRaises(Exception) as context:
            request.validate_va_request()
    ...
    def test_create_va_trx_id_not_valid_length_min(self):
        request = Util.generate_create_va_request()
        request.trx_id = ""
        with self.assertRaises(Exception) as context:
            request.validate_va_request()
    ...
    def test_create_va_trx_id_not_valid_length_max(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_total_amount_value_null(self):
        request = Util.generate_create_va_request()
        request.total_amount.value = None
        with self.assertRaises(Exception) as context:
            request.validate_va_request()
        self.assertEqual(str(context.exception.args[0]), "totalAmount.value cant be null")
    
    def test_create_va_total_amount_value_length_min(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_total_amount_value_length_max(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_total_amount_currency_length_min(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_total_amount_currency_not_idr(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_channel_length_min(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_va_trx_type_null(self):
        request = Util.generate_create_va_request()
        request.virtual_acc_trx_type = None
        with self.assertRaises(Exception) as context:
            request.validate_va_request()
        self.assertEqual("virtualTrxType cant be null", "virtualTrxType cant be null")
    
    def test_create_va_trx_type_length_min(self):
        request = Util.generate_create_va_request()
        request.virtual_acc_trx_type = ""
        with self.assertRaises(Exception) as context:
            request.validate_va_request()
        self.assertEqual(str(context.exception.args[0]), "virtualAccountTrxType must be exactly 1 character long. Ensure that virtualAccountTrxType is either 'C' or 'V' or 'O. Example: 'C'.")
    
    def test_create_va_trx_type_enum(self):
        request = Util.generate_create_va_request()
    ...
    def test_create_expired_date_format(self):
        request = Util.generate_create_va_request()
